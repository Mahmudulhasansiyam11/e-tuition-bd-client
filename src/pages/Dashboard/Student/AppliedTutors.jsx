...
const AppliedTutors = () => {
  ...
  // Approve and redirect to Stripe
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold text-[#0A3AFF] mb-6">Tutor Applications Received</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {visibleApplications.map((tutor) => (
          ...
          >
            <img
              src={tutor.tutorImage || "/assets/default-avatar.png"}
            ...
            <div className="flex-1">
              ...
              <p className={`mt-1 font-medium ${tutor.status === "Pending" ? "text-yellow-600" : "text-green-600"}`}>
                Status: {tutor.status}
              </p>
            </div>
